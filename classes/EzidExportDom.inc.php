...
// XML attributes
define('EZID_CROSSREF_XMLNS_XSI' , 'http://www.w3.org/2001/XMLSchema-instance');
define('EZID_CROSSREF_XMLNS' , 'http://www.crossref.org/schema/4.3.3');
define('EZID_CROSSREF_VERSION' , '4.3.3');
define('EZID_CROSSREF_XSI_SCHEMAVERSION' , '4.3.3');
define('EZID_CROSSREF_XSI_SCHEMALOCATION' , 'http://www.crossref.org/schema/4.3.3 http://www.crossref.org/schema/deposit/crossref4.3.3.xsd');

class EzidExportDom extends DOIExportDom {
  ...
  function getXmlSchemaVersion() {
    return EZID_CROSSREF_XSI_SCHEMAVERSION;
  }
  ...
  function getXmlSchemaLocation() {
    return EZID_CROSSREF_XSI_SCHEMALOCATION;
  }
  ...
  function &_generateJournalArticleDom(&$doc, &$journal, &$issue, &$section, &$article) {
    ...
    $DOIdataNode =& $this->_generateDOIdataDom($doc, $article->getPubId('doi'), Request::url(null, 'article', 'view', $article->getBestArticleId()), null);
